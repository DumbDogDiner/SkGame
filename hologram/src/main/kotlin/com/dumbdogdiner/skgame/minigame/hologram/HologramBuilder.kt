...
/**
 * Builder for quick creation of holograms - both programmatically, and by deserializing
 * data.
 */
class HologramBuilder {
	...
	*/
	 ...
	 */
	fun addLine(line: String): HologramBuilder {
		this.lines.add(line)
		return this
	}
...
x
	 */
	fun setLocation(location: Location): HologramBuilder {
		this.location = location.clone()
		return this
	}

	fun buildMetadata(): HologramMeta {
		return HologramMeta(
			this.location,
			this.lines,
		)
